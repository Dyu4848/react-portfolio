...
const About = ({ setCurrentPage }) => {
  return (
    <div id="info">
      ...
      <div>
        <img id="certificate" src="./images/certificate.png" alt="certificate"></img>
      </div>
